...
/**
 * Access to a collection protecting the critical section with synchronized
 */
public class SynchronizedListAccess {
    private static final Logger log = LoggerFactory.getLogger(SynchronizedListAccess.class);
